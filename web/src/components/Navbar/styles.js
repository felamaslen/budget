...
export const NavList = styled.nav`
    ...
    white-space: nowrap;
    user-select: none;
    box-shadow: 0 3px 9px ${colors['shadow-l3']},
        0 -2px 6px ${colors['shadow-l3']};
...
export const Link = styled(NavLink)`
    display: ${({ page }) => (page === 'logout' ? 'none' : 'block')};
    flex: 1 0 0;
    ...
    &::before {
        ...
        background-position: ${({ page }) => {
            ...
            return `-${200 + 28 * (index % 7)}px ${-(
                28 * Math.floor(index / 7)
            )}px`;
        }};
    }
