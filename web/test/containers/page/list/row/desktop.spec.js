...
import ListRowDesktop from '../../../../../src/containers/page/list/row/desktop';
import Column from '../../../../../src/containers/page/list/row/column';
import ListRowExtra from '../../../../../src/containers/page/list/row/extra';
import { EDIT_LIST_ITEM_DELETED } from '../../../../../src/constants/actions';

describe('List page <ListRowDesktop />', () => {
    const state = map({
        pages: map({
            food: map({
                rows: map([
    ...
    it('should render a list of columns', () => {
        expect(wrapper.childAt(0).is(Column)).to.equal(true);
        ...
        expect(wrapper.childAt(1).is(Column)).to.equal(true);
        ...
        expect(wrapper.childAt(2).is(Column)).to.equal(true);
        ...
        expect(wrapper.childAt(3).is(Column)).to.equal(true);
        ...
        expect(wrapper.childAt(4).is(Column)).to.equal(true);
    ...
    it('should render a <ListRowExtra /> component', () => {
        expect(wrapper.childAt(6).is(ListRowExtra)).to.equal(true);
