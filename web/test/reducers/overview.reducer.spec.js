    ...
    describe('rProcessDataOverview', () => {
        ...
        it('should return the correct calculated cost values', () => {
            expect(result).to.have.deep.property('cost', {
                balance: [13000, 15000, 16000, 15500, 0, 0, 0],
                balanceOld: [10000, 11500, 11200],
                balanceWithPredicted: [13000, 15000, 16000, 17249, 18948, 20147, 22146],
                predicted: [13740, 12832, 15698, 17249, 18948, 20147, 22146],
                spending: [1260, 2068, 802, 1251, 601, 601, 601],
                net: [740, -168, 698, 1249, 1699, 1199, 1999],
                income: [2000, 1900, 1500, 2500, 2300, 1800, 2600],
                funds: [100, 101, 102, 103, 103, 104, 104],
                fundsOld: [94, 105, 110],
                bills: [1000, 900, 400, 650, 0, 0, 0],
                food: [50, 13, 31, 29, 29, 29, 29],
                general: [150, 90, 16, 56, 56, 56, 56],
                social: [50, 65, 208, 145, 145, 145, 145],
                holiday: [10, 1000, 147, 371, 371, 371, 371]
            });
        });
    });
