...
export const makeCreateItem =
  <D extends CrudItem, J extends CrudItem, P extends CrudItem>({
    table: defaultTable,
    withUid = false,
    jsonToDb,
    dbToJson,
    ...
    validateParentDependency,
    createTopic,
  }: CrudOptionsExtended<D, J, P>): CreateItem<J> =>
  async (
    db: DatabaseTransactionConnectionType,
    uid: number,
    data: Create<J>,
...
export const makeReadItem =
  <D extends CrudItem, J extends CrudItem, P extends CrudItem>({
    ...
    dbToJson,
    item,
  }: CrudOptionsExtended<D, J, P>): ReadItem<J> =>
  async (
    db: DatabaseTransactionConnectionType,
    uid: number,
    id?: number,
...
export const makeUpdateItem =
  <D extends CrudItem, J extends CrudItem, P extends CrudItem>({
    ...
    validateParentDependency,
    updateTopic,
  }: CrudOptionsExtended<D, J, P>): UpdateItem<J> =>
  async (
    db: DatabaseTransactionConnectionType,
    uid: number,
    id: number,
