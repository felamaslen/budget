  ...
  it('should render a graph', async () => {
    ...
    expect(getByTestId('graph-svg')).toMatchInlineSnapshot(`
      ...
      >
        ...
        <g>
          <path
            d="M0,203.8 Q52,255 77.3,251.9 C109,248 130,202 163.0,181.8 C189,165 216,156 245.9,146.5 C275,137 301,132 331.5,125.2 C360,119 385,115 414.4,111.0 Q444,107 500.0,100.8"
            fill="none"
            stroke="#093"
            stroke-width="2"
          />
