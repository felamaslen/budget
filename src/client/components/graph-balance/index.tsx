...
function getGraphData(graph: OverviewGraph, showLiabilities: boolean): Line[] {
  ...
  const linesCommon: Line[] = [
    ...
    },
    {
      ...
      stack: [dataLockedCash, dataLiquidCash, dataStocks, dataPension],
    ...
    },
    {
      ...
      name: 'Stocks',
      data: dataStocks,
      stack: [dataLockedCash, dataLiquidCash],
    ...
    },
    {
      ...
      name: 'Pension',
      data: dataPension,
      stack: [dataLockedCash, dataLiquidCash, dataStocks],
      fill: true,
      smooth: true,
