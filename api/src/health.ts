...
const makeCheckReadiness = withSlonik(async (db) => {
...
export function healthRoutes(databaseName?: string): Router {
  const checkReadiness = makeCheckReadiness(databaseName);
