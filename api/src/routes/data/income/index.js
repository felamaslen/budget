...
function routeGet(req, res) {
    return listCommon.routeGet(req, res, 'income');
}
...
function routePost(req, res) {
    return listCommon.routePost(req, res, 'income');
}
...
function routePut(req, res) {
    return listCommon.routePut(req, res, 'income');
}
...
function routeDelete(req, res) {
    return listCommon.routeDelete(req, res, 'income');
}
