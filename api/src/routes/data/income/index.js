...
function routeGet(config, db) {
    return listCommon.routeGet(config, db, 'income');
}
...
function routePost(config, db) {
    return listCommon.routePost(config, db, 'income');
}
...
function routePut(config, db) {
    return listCommon.routePut(config, db, 'income');
}
...
function routeDelete(config, db) {
    return listCommon.routeDelete(config, db, 'income');
}
